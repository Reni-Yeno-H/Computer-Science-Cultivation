...
- [x] (Hao Ren Yuan) Debugging score fix, health fix, enemy health.
      
#### May 3rd, 2022:
- [x] (Simon Hsia) Continued Testing functionalities of BambooVillage map before fully adding parts to the rest of the game.
- [x] (Hao Ren Yuan) Started adding level 2 items to scene and more UI and score fix.

#### May 5th, 2022:
- [x] (Simon Hsia) Started adding proper items to the game.
- [x] (Simon Hsia) Started developing the website for the game.
- [x] (Hao Ren Yuan) Finished adding level 2 and short cutting to all relevant items to all levels.
- [x] (Hao Ren Yuan) More score and animation fix.
- [x] (Hao Ren Yuan) Added task manager so Simon can start adding CS questions in.
- [x] (Hao Ren Yuan) Added Credit Scene items.

#### May 6th, 2022:
- [x] (Hao Ren Yuan) Small changes in several scenes.
- [x] (Hao Ren Yuan) Added music audio to unity.
 
#### May 7th, 2022:
- [x] (Jacklyn Yoon) Added volume functionality to game.
- [x] (Hao Ren Yuan) Made persistent health and some changes for walking animation.
- [x] (Hao Ren Yuan) Drew last boss scene.
- [x] (Hao Ren Yuan) Tested unity objects and scripting for music.
  
#### May 8th, 2022:
- [x] (Hao Ren Yuan) Music changes.
- [x] (Hao Ren Yuan) Evergreen forest scene done and drew event choice scene.
- [x] (Hao Ren Yuan) Added scene items and creating animations to their corresponding and relevant scenes.
      
#### May 9th, 2022:
- [x] (Jacklyn Yoon) Started Adding Highscore functionality to game.
- [x] (Hao Ren Yuan) Persistent Data testings.
- [x] (Hao Ren Yuan) Polishing animations and creating projectile animation for relevant scenes.
- [x] (Hao Ren Yuan) Lava mountain map and final boss map level finished.

#### May 10th, 2022:
- [x] (Simon Hsia) Finished developing the website for the game.
- [x] (Hao Ren Yuan) Changed some positioning for map placements.
- [x] (Hao Ren Yuan) Fixed on death-score and end game score scene.
- [x] (Hao Ren Yuan) Level selection functionality added to menu and more UI fixes.
- [x] (Hao Ren Yuan) Score reset testings.

#### May 11th, 2022:
- [x] (Jacklyn Yoon) Finished adding Adding Highscore functionality to game.
- [x] (Hao Ren Yuan) Fixed UI buttons on menu scene.
- [x] (Hao Ren Yuan) Reset Score patches and combining several music audio into one.
- [x] (Hao Ren Yuan) Score positioning fixes.
